...
<head>
	...
	100%{opacity: 1;}
		...
		.both{clear: both;}
		.loginpage{position: fixed;background:url("assets/img/PK.jpg");height: 99%;width: 100%;background-size: 20%;}
...
<body>
	<div class="loginpage">
		...
		<div class="padding">
			<h3>Login Aplikasi Penjualan</h3><br/>
			<h3>Qcell</h3>
		<form id="loginapp">
			...
			<div class="both"></div>
			<a href="register.php" title="">Register</a><br>
			<p>&copy;pojokankantin.com</p>
		</form>
		<div id="status">
